                    ...
                    <ul class="nofitications-dropdown">
                        <li class="dropdown head-dpdn">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="#">
                                        <div class="user_img"><img src="${pageContext.request.contextPath}/resources/manages/images/p4.png" alt=""></div>
                                ...
                                <li class="odd"><a href="#">
                                        <div class="user_img"><img src="${pageContext.request.contextPath}/resources/manages/images/p2.png" alt=""></div>
                                        <div class="notification_desc">
                                            <p>Lorem ipsum dolor </p>
                                            <p><span>1 hour ago</span></p>
                                        </div>
                                ...
                                <li><a href="#">
                                        <div class="user_img"><img src="${pageContext.request.contextPath}/resources/manages/images/p3.png" alt=""></div>
                                        <div class="notification_desc">
                                            <p>Lorem ipsum dolor</p>
                                            <p><span>1 hour ago</span></p>
                                        </div>
                        ...
                        <li class="dropdown head-dpdn">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="#">
                                        <div class="user_img"><img src="${pageContext.request.contextPath}/resources/manages/images/p5.png" alt=""></div>
                                        <div class="notification_desc">
                                            <p>Lorem ipsum dolor</p>
                                            <p><span>1 hour ago</span></p>
                                        </div>
                                ...
                                <li class="odd"><a href="#">
                                        <div class="user_img"><img src="${pageContext.request.contextPath}/resources/manages/images/p6.png" alt=""></div>
                                        <div class="notification_desc">
                                            <p>Lorem ipsum dolor</p>
                                            <p><span>1 hour ago</span></p>
                                        </div>
                                ...
                                <li><a href="#">
                                        <div class="user_img"><img src="${pageContext.request.contextPath}/resources/manages/images/p7.png" alt=""></div>
                                        <div class="notification_desc">
                                            <p>Lorem ipsum dolor</p>
                                            <p><span>1 hour ago</span></p>
                                        </div>
                        ...
                        <li class="dropdown profile_details_drop">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                <div class="profile_img">	
                                    <span class="prfil-img"><img src="${pageContext.request.contextPath}/resources/manages/images/p1.png" alt=""> </span> 
                                    <div class="user-name">
